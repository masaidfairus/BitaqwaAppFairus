package com.fairus.bitaqwaappfairus.menu.doa.adapter
...
import com.fairus.bitaqwaappfairus.menu.doa.DetailDoaActivity
import com.fairus.bitaqwaappfairus.menu.doa.model.DoaModel

class DoaListAdapter(
    private val listDoa: ArrayList<DoaModel>,
    private val title: String,
    private val logo: Int) : RecyclerView.Adapter<DoaListAdapter.ListViewHolder>() {
